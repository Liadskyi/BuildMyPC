...
function Contact(props) {
    ...
    <div className={styles.contact_cont} id="contact_cont" style={{opacity: props.opac}}>
        ...
        <p className={`${styles.contact_inf} ${styles.tg}`}>Tik-tok: <a href="https://www.tiktok.com/@build_my_pc?is_from_webapp=1&sender_device=pc"className={styles.cl}>kliknij</a></p>
    </div>
    </>);
}
